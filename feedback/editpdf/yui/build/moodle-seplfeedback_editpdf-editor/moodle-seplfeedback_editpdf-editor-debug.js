YUI.add('moodle-seplfeedback_editpdf-editor', function (Y, NAME) {
...
var POINT = function(x, y) {
     ...
     * @method clip
     * @param M.seplfeedback_editpdf.point
     * @public
     */
...
M.seplfeedback_editpdf.point = POINT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.rect = RECT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var EDIT = function() {
     ...
     * @property start
     * @type M.seplfeedback_editpdf.point|false
     * @public
     */
    this.start = false;
     ...
     * @property path
     * @type M.seplfeedback_editpdf.point[]
     * @public
     */
    this.path = [];
};
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.edit = EDIT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 *
 * @namespace M.seplfeedback_editpdf
 * @param M.seplfeedback_editpdf.editor editor
 * @class drawable
 */
var DRAWABLE = function(editor) {

    /**
     * Reference to M.seplfeedback_editpdf.editor.
     * @property editor
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.drawable = DRAWABLE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATION, Y.Base, {
    ...
    /**
     * Reference to M.seplfeedback_editpdf.drawable
     * @property drawable
     * @type M.seplfeedback_editpdf.drawable
     * @public
     */
    drawable : false,
     ...
     * @return M.seplfeedback_editpdf.drawable
     */
    draw_highlight : function() {
        ...
        if (this.editor.currentannotation === this) {
            ...
            bounds = new M.seplfeedback_editpdf.rect();
            bounds.bound([new M.seplfeedback_editpdf.point(this.x, this.y),
                          new M.seplfeedback_editpdf.point(this.endx, this.endy)]);
            ...
            var deleteicon = Y.Node.create('<img src="' + M.util.image_url('trash', 'seplfeedback_editpdf') + '"/>'),
                deletelink = Y.Node.create('<a href="#" role="button"></a>');

            deleteicon.setAttrs({
                'alt': M.util.get_string('deleteannotation', 'seplfeedback_editpdf')
            });
     ...
     * @public
     * @method draw
     * @return M.seplfeedback_editpdf.drawable|false
     */
    draw : function() {
     ...
     * @param M.seplfeedback_editpdf.edit edit
     */
    ...
    init_from_edit : function(edit) {
        var bounds = new M.seplfeedback_editpdf.rect();
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.annotation = ANNOTATION;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 * @extends M.seplfeedback_editpdf.annotation
 */
...
Y.extend(ANNOTATIONLINE, M.seplfeedback_editpdf.annotation, {
    /**
    ...
    draw : function() {
        ...
        drawable = new M.seplfeedback_editpdf.drawable(this.editor);
     ...
     */
    draw_current_edit : function(edit) {
        var drawable = new M.seplfeedback_editpdf.drawable(this.editor),
            shape;
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.annotationline = ANNOTATIONLINE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONRECTANGLE, M.seplfeedback_editpdf.annotation, {
    /**
    ...
    draw_current_edit : function(edit) {
        ...
        bounds = new M.seplfeedback_editpdf.rect();
        bounds.bound([new M.seplfeedback_editpdf.point(edit.start.x, edit.start.y),
                      new M.seplfeedback_editpdf.point(edit.end.x, edit.end.y)]);
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.annotationrectangle = ANNOTATIONRECTANGLE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONOVAL, M.seplfeedback_editpdf.annotation, {
    /**
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.annotationoval = ANNOTATIONOVAL;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONPEN, M.seplfeedback_editpdf.annotation, {
    /**
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.annotationpen = ANNOTATIONPEN;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONHIGHLIGHT, M.seplfeedback_editpdf.annotation, {
    /**
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.annotationhighlight = ANNOTATIONHIGHLIGHT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONSTAMP, M.seplfeedback_editpdf.annotation, {
    /**
    ...
    draw : function() {
        ...
        position = this.editor.get_window_coordinates(new M.seplfeedback_editpdf.point(this.x, this.y));
    ...
    draw_current_edit : function(edit) {
        ...
        bounds.bound([edit.start, edit.end]);
        position = this.editor.get_window_coordinates(new M.seplfeedback_editpdf.point(bounds.x, bounds.y));
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.annotationstamp = ANNOTATIONSTAMP;
...
Y.extend(DROPDOWN, M.core.dialogue, {
    ...
    initializer : function(config) {
        ...
        bb.addClass('seplfeedback_editpdf_dropdown');
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.dropdown = DROPDOWN;
 ...
 * @class colourpicker
 * @constructor
 * @extends M.seplfeedback_editpdf.dropdown
 */
COLOURPICKER = function(config) {
    COLOURPICKER.superclass.constructor.apply(this, [config]);
};

Y.extend(COLOURPICKER, M.seplfeedback_editpdf.dropdown, {
     ...
     */
    initializer : function(config) {
        var colourlist = Y.Node.create('<ul role="menu" class="seplfeedback_editpdf_menu"/>'),
            body;
        ...
        Y.each(this.get('colours'), function(rgb, colour) {
            ...
            title = M.util.get_string(colour, 'seplfeedback_editpdf');
            iconname = this.get('iconprefix') + colour;
            img = M.util.image_url(iconname, 'seplfeedback_editpdf');
        ...
        this.set('headerText', M.util.get_string('colourpicker', 'seplfeedback_editpdf'));
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.colourpicker = COLOURPICKER;
...
Y.extend(STAMPPICKER, M.seplfeedback_editpdf.dropdown, {
     ...
     */
    initializer : function(config) {
        var stamplist = Y.Node.create('<ul role="menu" class="seplfeedback_editpdf_menu"/>');

        // Build a list of stamped buttons.
        Y.each(this.get('stamps'), function(stamp) {
            var button, listitem, title;

            title = M.util.get_string('stamp', 'seplfeedback_editpdf');
        ...
        // Set the accessible header text.
        this.set('headerText', M.util.get_string('stamppicker', 'seplfeedback_editpdf'));
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.stamppicker = STAMPPICKER;
...
Y.extend(COMMENTMENU, M.seplfeedback_editpdf.dropdown, {
    ...
    initializer : function(config) {
        ...
        commentlinks = Y.Node.create('<ul role="menu" class="seplfeedback_editpdf_menu"/>');

        link = Y.Node.create('<li><a tabindex="-1" href="#">' +
               M.util.get_string('addtoquicklist', 'seplfeedback_editpdf') +
               '</a></li>');
        ...
        link = Y.Node.create('<li><a tabindex="-1" href="#">' +
               M.util.get_string('deletecomment', 'seplfeedback_editpdf') +
               '</a></li>');
        ...
        // Set the accessible header text.
        this.set('headerText', M.util.get_string('commentcontextmenu', 'seplfeedback_editpdf'));
        ...
        Y.each(comment.editor.quicklist.comments, function(quickcomment) {
            var listitem = Y.Node.create('<li class="quicklist_comment"></li>'),
                ...
                deletelinkitem = Y.Node.create('<a href="#" tabindex="-1" class="delete_quicklist_comment">' +
                                               ...
                                               'alt="' + M.util.get_string('deletecomment', 'seplfeedback_editpdf') + '"/>' +
                                               '</a>');
    ...
    ATTRS : {
         ...
         *
         * @attribute comment
         * @type M.seplfeedback_editpdf.comment
         * @default null
         */
        comment : {
            value : null
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.commentmenu = COMMENTMENU;
...
var COMMENT = function(editor, gradeid, pageno, x, y, width, colour, rawtext) {
     ...
     * @property menu
     * @type M.seplfeedback_editpdf.dropdown
     * @public
     */
    this.menu = null;
    ...
    this.attach_events = function(node, menu) {
        ...
        node.on('gesturemove', function(e) {
            ...
            newlocation = this.editor.get_canvas_coordinates(new M.seplfeedback_editpdf.point(x, y));
        ...
        this.menu = new M.seplfeedback_editpdf.commentmenu({
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.comment = COMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.quickcomment = QUICKCOMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var QUICKCOMMENTLIST = function(editor) {
     ...
     * Array of Comments
     * @property shapes
     * @type M.seplfeedback_editpdf.quickcomment[]
     * @public
     */
    this.comments = [];
    ...
    this.add = function(comment) {
        ...
        config = {
            ...
            data : {
                ...
                'seplmentid' : this.editor.get('seplmentid')
            },
            on: {
                success: function(tid, response) {
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            quickcomment = new M.seplfeedback_editpdf.quickcomment(jsondata.id,
                                                                                     jsondata.rawtext,
                                                                                     jsondata.width,
                                                                                     jsondata.colour);
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            Y.each(jsondata, function(comment) {
                                var quickcomment = new M.seplfeedback_editpdf.quickcomment(comment.id,
                                                                                             comment.rawtext,
                                                                                             comment.width,
                                                                                             comment.colour);
                                this.comments.push(quickcomment);
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.quickcommentlist = QUICKCOMMENTLIST;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
EDITOR.prototype = {
     ...
     * @type M.seplfeedback_editpdf.edit
     * @protected
     */
    currentedit : new M.seplfeedback_editpdf.edit(),

    /**
     * Current drawable.
     *
     * @property currentdrawable
     * @type M.seplfeedback_editpdf.drawable|false
     * @protected
     */
     ...
     *
     * @property drawables
     * @type array(M.seplfeedback_editpdf.drawable)
     * @protected
     */
    drawables : [],
     ...
     * @type M.seplfeedback_editpdf.annotation
     * @protected
     */
     ...
     * @property quicklist
     * @type M.seplfeedback_editpdf.quickcommentlist
     * @protected
     */
    quicklist : null,
    ...
    initializer : function() {
        ...
        if (link) {
            ...
            if (!this.get('readonly')) {
                this.quicklist = new M.seplfeedback_editpdf.quickcommentlist(this);
            }
        }
    },
    ...
    refresh_button_state : function() {
        ...
        imgurl = M.util.image_url('background_colour_' + this.currentedit.commentcolour, 'seplfeedback_editpdf');
        ...
        imgurl = M.util.image_url('colour_' + this.currentedit.annotationcolour, 'seplfeedback_editpdf');
        button.one('img').setAttribute('src', imgurl);

        currenttoolnode = Y.one(TOOLSELECTOR[this.currentedit.tool]);
        currenttoolnode.addClass('seplfeedback_editpdf_selectedbutton');
    ...
    get_canvas_bounds : function() {
        ...
        return new M.seplfeedback_editpdf.rect(offsetleft, offsettop, width, height);
    },

    /**
     * Called to translate from window coordinates to canvas coordinates.
     * @method get_canvas_coordinates
     * @param M.seplfeedback_editpdf.point point in window coordinats.
     */
    get_canvas_coordinates : function(point) {
        var bounds = this.get_canvas_bounds(),
            newpoint = new M.seplfeedback_editpdf.point(point.x - bounds.x, point.y - bounds.y);
    ...
    load_all_pages : function() {
        ...
        config = {
            ...
            data : {
                ...
                seplmentid : this.get('seplmentid'),
    ...
    all_pages_loaded : function(responsetext) {
        ...
        try {
            ...
            if (data.error || !data.pagecount) {
                ...
                error = new M.core.alert({ message: M.util.get_string('cannotopenpdf', 'seplfeedback_editpdf') });
                error.show();
                return;
            }
        } catch (e) {
            this.dialogue.hide();
            // Display alert dialogue.
            error = new M.core.alert({ title: M.util.get_string('cannotopenpdf', 'seplfeedback_editpdf')});
            error.show();
            return;
        }
        ...
        for (i = 0; i < this.pages.length; i++) {
            for (j = 0; j < this.pages[i].comments.length; j++) {
                ...
                this.pages[i].comments[j] = new M.seplfeedback_editpdf.comment(this,
                                                                                 comment.gradeid,
                                                                                 comment.pageno,
                                                                                 comment.x,
                                                                                 comment.y,
    ...
    setup_toolbar : function() {
        ...
        picker = new M.seplfeedback_editpdf.colourpicker({
        ...
        if (stampfiles.length <= 0) {
            ...
            picker = new M.seplfeedback_editpdf.stamppicker({
    ...
    handle_tool_button : function(e, tool) {
        ...
        currenttoolnode = Y.one(TOOLSELECTOR[this.currentedit.tool]);
        currenttoolnode.removeClass('seplfeedback_editpdf_selectedbutton');
    ...
    get_current_drawable : function() {
        ...
        if (this.currentedit.tool === 'comment') {
            comment = new M.seplfeedback_editpdf.comment(this);
    ...
    edit_move : function(e) {
        ...
        var bounds = this.get_canvas_bounds(),
            ...
            clientpoint = new M.seplfeedback_editpdf.point(e.clientX + canvas.get('docScrollX'),
    ...
    create_annotation : function(type, data) {
        ...
        data.editor = this;
        if (type === "line") {
            return new M.seplfeedback_editpdf.annotationline(data);
        } else if (type === "rectangle") {
            return new M.seplfeedback_editpdf.annotationrectangle(data);
        } else if (type === "oval") {
            return new M.seplfeedback_editpdf.annotationoval(data);
        } else if (type === "pen") {
            return new M.seplfeedback_editpdf.annotationpen(data);
        } else if (type === "highlight") {
            return new M.seplfeedback_editpdf.annotationhighlight(data);
        } else if (type === "stamp") {
            return new M.seplfeedback_editpdf.annotationstamp(data);
        }
        return false;
    },
    ...
    open_search_comments : function(e) {
        if (!this.searchcommentswindow) {
            this.searchcommentswindow = new M.seplfeedback_editpdf.commentsearch({
                editor : this
            });
        }
    ...
    setup_navigation : function() {
        ...
        if (options.size() <= 1) {
            for (i = 0; i < this.pages.length; i++) {
                ...
                option.setHTML(M.util.get_string('pagenumber', 'seplfeedback_editpdf', i+1));
...
Y.extend(EDITOR, Y.Base, EDITOR.prototype, {
    NAME : 'moodle-seplfeedback_editpdf-editor',
    ATTRS : {
        userid : {
...
M.seplfeedback_editpdf = M.seplfeedback_editpdf || {};
M.seplfeedback_editpdf.editor = M.seplfeedback_editpdf.editor || {};
 ...
 * @param {Object} params
 */
M.seplfeedback_editpdf.editor.init = M.seplfeedback_editpdf.editor.init || function(params) {
