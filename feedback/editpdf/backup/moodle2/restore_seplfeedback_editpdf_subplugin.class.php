 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_seplfeedback_editpdf_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_seplfeedback_editpdf_files($data) {
        $data = (object)$data;

        // In this case the id is the old gradeid which will be mapped.
        $this->add_related_files('seplfeedback_editpdf',
            \seplfeedback_editpdf\document_services::FINAL_PDF_FILEAREA, 'grade', null, $data->gradeid);
        $this->add_related_files('seplfeedback_editpdf',
            \seplfeedback_editpdf\document_services::PAGE_IMAGE_READONLY_FILEAREA, 'grade', null, $data->gradeid);
        $this->add_related_files('seplfeedback_editpdf', 'stamps', 'grade', null, $data->gradeid);
    }
     ...
     * @param mixed $data
     */
    public function process_seplfeedback_editpdf_annotation($data) {
        global $DB;
        ...
        $DB->insert_record('seplfeedback_editpdf_annot', $data);
     ...
     * @param mixed $data
     */
    public function process_seplfeedback_editpdf_comment($data) {
        global $DB;
        ...
        $DB->insert_record('seplfeedback_editpdf_cmnt', $data);
