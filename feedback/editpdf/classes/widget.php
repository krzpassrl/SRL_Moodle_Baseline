 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class seplfeedback_editpdf_widget implements renderable {

    /** @var int $seplment - Assignment instance id */
    public $seplment = 0;
    ...
    /**
     * Constructor
     * @param int $seplment - Assignment instance id
     ...
     */
    public function __construct($seplment, $userid, $attemptnumber, $downloadurl,
