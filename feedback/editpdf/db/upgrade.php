 ...
 * @return bool
 */
function xmldb_seplfeedback_editpdf_upgrade($oldversion) {
    global $CFG;
    ...
    if ($oldversion < 2013110800) {
        ...
        $fs = get_file_storage();
        $stamps = $fs->get_area_files(context_system::instance()->id, 'seplfeedback_editpdf',
        ...
        if (empty($stamps)) {
            ...
            $filerecord->component = 'seplfeedback_editpdf';
            ...
            foreach ($defaultstamps as $stamp) {
                ...
                $fs->create_file_from_pathname($filerecord,
                    $CFG->dirroot . '/mod/sepl/feedback/editpdf/pix/' . $filerecord->filename);
            }
        }

        upgrade_plugin_savepoint(true, 2013110800, 'seplfeedback', 'editpdf');
    }
