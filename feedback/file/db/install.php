...
/**
 * Post-install code for the seplfeedback_file module.
 *
...
/**
 * Code run after the seplfeedback_file module database tables have been created.
 * Moves the feedback file plugin down
 *
 * @return bool
 */
function xmldb_seplfeedback_file_install() {
    global $CFG;
