 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class seplfeedback_file_upload_zip_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'uploadzip', get_string('uploadzip', 'seplfeedback_file'));
        ...
        $mform->addHelpButton('feedbackzip', 'feedbackzip', 'seplfeedback_file');
        ...
        $this->add_action_buttons(true, get_string('importfeedbackfiles', 'seplfeedback_file'));
