 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class seplfeedback_file_batch_upload_files_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'batchuploadfilesforusers', get_string('batchuploadfilesforusers', 'seplfeedback_file',
            count($params['users'])));
        $mform->addElement('static', 'userslist', get_string('selectedusers', 'seplfeedback_file'), $params['usershtml']);
        ...
        $this->add_action_buttons(true, get_string('uploadfiles', 'seplfeedback_file'));
