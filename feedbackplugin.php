...
require_once($CFG->dirroot.'/mod/sepl/seplmentplugin.php');

/**
 * Abstract class for feedback_plugin inherited from sepl_plugin abstract class.
 *
 * @package   mod_sepl
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class sepl_feedback_plugin extends sepl_plugin {
     ...
     *
     * A grading action is a page that is not specific to a user but to the whole seplment.
     * @return array - An array of action and description strings.
