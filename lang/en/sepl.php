...
/**
 * Strings for component 'sepl', language 'en'
 *
 * @package   mod_sepl
...
$string['activityoverview'] = 'You have seplments that need attention';
...
$string['allowsubmissions'] = 'Allow the user to continue making submissions to this seplment.';
...
$string['allowsubmissionsfromdatesummary'] = 'This seplment will accept submissions from <strong>{$a}</strong>';
$string['allowsubmissionsanddescriptionfromdatesummary'] = 'The seplment details and submission form will be available from <strong>{$a}</strong>';
...
$string['sepl:addinstance'] = 'Add a new seplment';
$string['sepl:exportownsubmission'] = 'Export own submission';
$string['sepl:editothersubmission'] = 'Edit another student\'s submission';
$string['sepl:grade'] = 'Grade seplment';
$string['sepl:grantextension'] = 'Grant extension';
$string['sepl:manageallocations'] = 'Manage markers allocated to submissions';
$string['sepl:managegrades'] = 'Review and release grades';
$string['sepl:receivegradernotifications'] = 'Receive grader submission notifications';
$string['sepl:releasegrades'] = 'Release grades';
$string['sepl:revealidentities'] = 'Reveal student identities';
$string['sepl:reviewgrades'] = 'Review grades';
$string['sepl:viewblinddetails'] = 'View student identities when blind marking is enabled';
$string['sepl:viewgrades'] = 'View grades';
$string['sepl:submit'] = 'Submit seplment';
$string['sepl:view'] = 'View seplment';
$string['seplfeedback'] = 'Feedback plugin';
$string['seplfeedbackpluginname'] = 'Feedback plugin';
$string['seplmentisdue'] = 'Assignment is due';
$string['seplmentmail'] = '{$a->grader} has posted some feedback on your
seplment submission for \'{$a->seplment}\'

You can see it appended to your seplment submission:

    {$a->url}';
$string['seplmentmailhtml'] = '<p>{$a->grader} has posted some feedback on your
seplment submission for \'<i>{$a->seplment}</i>\'.</p>
<p>You can see it appended to your <a href="{$a->url}">seplment submission</a>.</p>';
$string['seplmentmailsmall'] = '{$a->grader} has posted some feedback on your
seplment submission for \'{$a->seplment}\' You can see it appended to your submission';
$string['seplmentname'] = 'Assignment name';
$string['seplmentplugins'] = 'Assignment plugins';
$string['seplmentsperpage'] = 'Assignments per page';
$string['seplsubmission'] = 'Submission plugin';
$string['seplsubmissionpluginname'] = 'Submission plugin';
...
$string['attemptreopenmethod_help'] = 'Determines how student submission attempts are reopened. The available options are: <ul><li>Never - The student submission cannot be reopened.</li><li>Manually - The student submission can be reopened by a teacher.</li><li>Automatically until pass - The student submission is automatically reopened until the student achieves the grade to pass value set in the Gradebook (Gradebook setup section) for this seplment.</li></ul>';
...
$string['backtoseplment'] = 'Back to seplment';
...
$string['blindmarking_help'] = 'Blind marking hides the identity of students from markers. Blind marking settings will be locked once a submission or grade has been made in relation to this seplment.';
$string['changegradewarning'] = 'This seplment has graded submissions and changing the grade will not automatically re-calculate existing submission grades. You must re-grade all existing submissions, if you wish to change the grade.';
...
$string['conversionexception'] = 'Could not convert seplment. Exception was: {$a}.';
...
$string['couldnotconvertgrade'] = 'Could not convert seplment grade for user {$a}.';
$string['couldnotconvertsubmission'] = 'Could not convert seplment submission for user {$a}.';
$string['couldnotcreatecoursemodule'] = 'Could not create course module.';
$string['couldnotcreatenewseplmentinstance'] = 'Could not create new seplment instance.';
$string['couldnotfindseplmenttoupgrade'] = 'Could not find old seplment instance to upgrade.';
...
$string['cutoffdate_help'] = 'If set, the seplment will not accept submissions after this date without an extension.';
...
$string['defaultsettings'] = 'Default seplment settings';
$string['defaultsettings_help'] = 'These settings define the defaults for all new seplments.';
...
$string['duedate_help'] = 'This is when the seplment is due. Submissions will still be allowed after this date but any seplments submitted after this date are marked as late. To prevent submissions after a certain date - set the seplment cut off date.';
$string['duedateno'] = 'No due date';
$string['submissionempty'] = 'Nothing was submitted';
$string['duedatereached'] = 'The due date for this seplment has now passed';
...
$string['gradersubmissionupdatedtext'] = '{$a->username} has updated their seplment submission
for \'{$a->seplment}\' at {$a->timeupdated}

It is available here:

    {$a->url}';
$string['gradersubmissionupdatedhtml'] = '{$a->username} has updated their seplment submission
for <i>\'{$a->seplment}\'  at {$a->timeupdated}</i><br /><br />
It is <a href="{$a->url}">available on the web site</a>.';
$string['gradersubmissionupdatedsmall'] = '{$a->username} has updated their submission for seplment {$a->seplment}.';
...
$string['errorquickgradingvsadvancedgrading'] = 'The grades were not saved because this seplment is currently using advanced grading';
...
seplment submission for \'<i>{$a->seplment}</i>\'<br /><br />
You can see it appended to your <a href="{$a->url}">seplment submission</a>.';
$string['feedbackavailablesmall'] = '{$a->username} has given feedback for seplment {$a->seplment}';
...
$string['feedbackpluginforgradebook_help'] = 'Only one seplment feedback plugin can push feedback into the gradebook.';
...
$string['introattachments_help'] = 'Additional files for use in the seplment, such as answer templates, may be added. Download links for the files will then be displayed on the seplment page under the description.';
...
$string['manageseplfeedbackplugins'] = 'Manage seplment feedback plugins';
$string['manageseplsubmissionplugins'] = 'Manage seplment submission plugins';
...
$string['maxgrade'] = 'Maximum Grade';
$string['messageprovider:sepl_notification'] = 'Assignment notifications';
$string['modulename'] = 'Assignment';
$string['modulename_help'] = 'The seplment activity module enables a teacher to communicate tasks, collect work and provide grades and feedback.

Students can submit any digital content (files), such as word-processed documents, spreadsheets, images, or audio and video clips. Alternatively, or in addition, the seplment may require students to type text directly into the text editor. An seplment can also be used to remind students of \'real-world\' seplments they need to complete offline, such as art work, and thus not require any digital content. Students can submit work individually or as a member of a group.

When reviewing seplments, teachers can leave feedback comments and upload files, such as marked-up student submissions, documents with comments or spoken audio feedback. Assignments can be graded using a numerical or custom scale or an advanced grading method such as a rubric. Final grades are recorded in the gradebook.';
$string['modulename_link'] = 'mod/seplment/view';
...
$string['noonlinesubmissions'] = 'This seplment does not require you to submit anything online';
$string['nosavebutnext'] = 'Next';
$string['nosubmission'] = 'Nothing has been submitted for this seplment';
...
$string['numberofsubmittedseplments'] = 'Submitted';
...
$string['page-mod-sepl-x'] = 'Any seplment module page';
$string['page-mod-sepl-view'] = 'Assignment module main and submission page';
...
$string['preventsubmissions'] = 'Prevent the user from making any more submissions to this seplment.';
...
$string['quickgrading_help'] = 'Quick grading allows you to sepl grades (and outcomes) directly in the submissions table. Quick grading is not compatible with advanced grading and is not recommended when there are multiple markers.';
...
$string['requiresubmissionstatement_help'] = 'Require that students accept the submission statement for all submissions to this seplment.';
$string['requireallteammemberssubmit'] = 'Require all group members submit';
$string['requireallteammemberssubmit_help'] = 'If enabled, all members of the student group must click the submit button for this seplment before the group submission will be considered as submitted. If disabled, the group submission will be considered as submitted as soon as any member of the student group clicks the submit button.';
$string['recordid'] = 'Identifier';
$string['revealidentities'] = 'Reveal student identities';
$string['revealidentitiesconfirm'] = 'Are you sure you want to reveal student identities for this seplment? This operation cannot be undone. Once the student identities have been revealed, the marks will be released to the gradebook.';
...
$string['sendnotifications_help'] = 'If enabled, graders (usually teachers) receive a message whenever a student submits an seplment, early, on time and late. Message methods are configurable.';
$string['selectlink'] = 'Select...';
$string['selectuser'] = 'Select {$a}';
$string['sendlatenotifications'] = 'Notify graders about late submissions';
$string['sendlatenotifications_help'] = 'If enabled, graders (usually teachers) receive a message whenever a student submits an seplment late. Message methods are configurable.';
$string['sendsubmissionreceipts'] = 'Send submission receipt to students';
$string['sendsubmissionreceipts_help'] = 'This switch will enable submission receipts for students. Students will receive a notification every time they successfully submit an seplment';
...
You can see the status of your seplment submission:

    {$a->url}';
$string['submissioncopiedhtml'] = '<p>You have made a copy of your previous
seplment submission for \'<i>{$a->seplment}</i>\'.</p>
<p>You can see the status of your <a href="{$a->url}">seplment submission</a>.</p>';
$string['submissioncopiedsmall'] = 'You have copied your previous seplment submission for {$a->seplment}';
...
$string['submissionnotready'] = 'This seplment is not ready to submit:';
$string['submissionplugins'] = 'Submission plugins';
$string['submissionreceipts'] = 'Send submission receipts';
$string['submissionreceiptothertext'] = 'Your seplment submission for
\'{$a->seplment}\' has been submitted.

You can see the status of your seplment submission:

    {$a->url}';
$string['submissionreceiptotherhtml'] = 'Your seplment submission for
\'<i>{$a->seplment}</i>\' has been submitted.<br /><br />
You can see the status of your <a href="{$a->url}">seplment submission</a>.';
$string['submissionreceiptothersmall'] = 'Your seplment submission for {$a->seplment} has been submitted.';
...
You can see the status of your seplment submission:
    ...
    {$a->url}';
$string['submissionreceipthtml'] = '<p>You have submitted an seplment submission for \'<i>{$a->seplment}</i>\'.</p>
<p>You can see the status of your <a href="{$a->url}">seplment submission</a>.</p>';
$string['submissionreceiptsmall'] = 'You have submitted your seplment submission for {$a->seplment}';
$string['submissionslocked'] = 'This seplment is not accepting submissions';
...
$string['submissionstatementdefault'] = 'This seplment is my own work, except where I have acknowledged the use of the works of other people.';
...
$string['submitseplment_help'] = 'Once this seplment is submitted you will not be able to make any more changes.';
$string['submitseplment'] = 'Submit seplment';
...
$string['subplugintype_seplsubmission'] = 'Submission plugin';
$string['subplugintype_seplsubmission_plural'] = 'Submission plugins';
$string['subplugintype_seplfeedback'] = 'Feedback plugin';
$string['subplugintype_seplfeedback_plural'] = 'Feedback plugins';
...
$string['teamsubmissiongroupingid_help'] = 'This is the grouping that the seplment will use to find groups for student groups. If not set - the default set of groups will be used.';
...
$string['viewownsubmissionform'] = 'View own submit seplment page.';
