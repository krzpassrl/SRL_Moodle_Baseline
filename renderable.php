...
/**
 * This file contains the definition for the renderable classes for the seplment
 *
 * @package   mod_sepl
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_submit_for_grading_page implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_gradingmessage implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_form implements renderable {
    /** @var moodleform $form is the edit submission form */
    public $form = null;
    /** @var string $classname is the name of the class to sepl to the container */
    public $classname = '';
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_user_summary implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_feedback_plugin_feedback implements renderable {
    /** @var int SUMMARY */
    const SUMMARY                = 10;
    /** @var int FULL */
    const FULL                   = 20;

    /** @var sepl_submission_plugin $plugin */
    public $plugin = null;
    /** @var stdClass $grade */
    public $grade = null;
    /** @var string $view */
     ...
     *
     * @param sepl_feedback_plugin $plugin
     ...
     */
    public function __construct(sepl_feedback_plugin $plugin,
                                stdClass $grade,
                                $view,
                                $coursemoduleid,
                                $returnaction,
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_submission_plugin_submission implements renderable {
    /** @var int SUMMARY */
    const SUMMARY                = 10;
    /** @var int FULL */
    const FULL                   = 20;
    ...
    /**
     * Constructor
     * @param sepl_submission_plugin $plugin
     ...
     */
    public function __construct(sepl_submission_plugin $plugin,
                                stdClass $submission,
                                $view,
                                $coursemoduleid,
                                $returnaction,
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_feedback_status implements renderable {
    ...
    /** @var stdClass sepl_grade record */
    public $grade = null;
    /** @var int coursemoduleid */
    public $coursemoduleid = 0;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_submission_status implements renderable {
     ...
     * @param array $usergroups - Array containing all groups the user is sepled to
     */
...
/**
 * Used to output the attempt history for a particular seplment.
 *
 * @package mod_sepl
 * @copyright 2012 Davo Smith, Synergy Learning
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_attempt_history implements renderable {
    ...
    public $feedbackplugins = array();
    /** @var int coursemoduleid - The cmid for the seplment */
    public $coursemoduleid = 0;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_header implements renderable {
    /** @var stdClass the sepl record  */
    public $sepl = null;
     ...
     * Constructor
     *
     * @param stdClass $sepl  - the sepl database record
     ...
     */
    public function __construct(stdClass $sepl,
                                $context,
                                $showintro,
                                $coursemoduleid,
                                $subpage='',
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_plugin_header implements renderable {
    /** @var sepl_plugin $plugin */
    public $plugin = null;

    /**
     * Header for a single plugin
     *
     * @param sepl_plugin $plugin
     */
    public function __construct(sepl_plugin $plugin) {
        $this->plugin = $plugin;
    }
}
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_grading_summary implements renderable {
    /** @var int participantcount - The number of users who can submit to this seplment */
    ...
    /** @var int duedate - The seplment due date (if one is set) */
    public $duedate = 0;
    /** @var int cutoffdate - The seplment cut off date (if one is set) */
    public $cutoffdate = 0;
    /** @var int coursemoduleid - The seplment course module id */
    public $coursemoduleid = 0;
    /** @var boolean teamsubmission - Are team submissions enabled for this seplment */
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_course_index_summary implements renderable {
    /** @var array seplments - A list of course module info and submission counts or statuses */
    public $seplments = array();
     ...
     * @param int $timedue - The due date for the seplment - may be 0 if no duedate
     * @param string $submissioninfo - A string with either the number of submitted seplments, or the
     ...
     */
    public function add_sepl_info($cmid, $cmname, $sectionname, $timedue, $submissioninfo, $gradeinfo) {
        $this->seplments[] = array('cmid'=>$cmid,
                               'cmname'=>$cmname,
...
/**
 * An sepl file class that extends rendererable class and is used by the sepl module.
 *
 * @package   mod_sepl
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_files implements renderable {
    /** @var context $context */
    public $context;
    /** @var string $context */
    public $dir;
    ...
    public function __construct(context $context, $sid, $filearea, $component) {
        ...
        if (!empty($CFG->enableportfolios)) {
            ...
            if (count($files) >= 1 &&
                    has_capability('mod/sepl:exportownsubmission', $this->context)) {
                $button = new portfolio_add_button();
                $callbackparams = array('cmid' => $this->cm->id,
                                        'sid' => $sid,
                                        'area' => $filearea,
                                        'component' => $component);
                $button->set_callback_options('sepl_portfolio_caller',
                                              $callbackparams,
                                              'mod_sepl');
