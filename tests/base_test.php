...
/**
 * Base class for unit tests for mod_sepl.
 *
 * @package    mod_sepl
 * @category   phpunit
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_sepl_base_testcase extends advanced_testcase {
    ...
    /** @var stdClass $course New course created to hold the seplments */
    ...
    /**
     * Setup function - we will create a course and add an sepl instance to it.
     */
    ...
    /**
     * Convenience function to create a testable instance of an seplment.
     *
     * @param array $params Array of parameters to pass to the generator
     * @return testable_sepl Testable wrapper around the sepl class.
     */
    protected function create_instance($params=array()) {
        ...
        return new testable_sepl($context, $cm, $this->course);
    }
 ...
 */
class testable_sepl extends sepl {
    ...
    public function testable_grading_batch_operations_form($operation, $selectedusers) {
        ...
        mod_sepl_grading_batch_operations_form::mock_submit($data);
        ...
        $mform = new mod_sepl_grading_batch_operations_form(null, $formparams);
