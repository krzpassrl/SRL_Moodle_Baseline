@mod @mod_sepl @_file_upload
Feature: In an seplment, students can upload files for assessment
  In order to complete my seplments providing files
  As a student
  ...
  Scenario: Submit a file and update the submission with another file
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      ...
      | seplsubmission_onlinetext_enabled | 0 |
