@mod @mod_sepl
Feature: In an seplment, students can add and edit text online
  In order to complete my submissions online
  As a student
  I need to submit my seplment editing an online form
  ...
  Scenario: Submit a text online and edit the submission
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      ...
      | seplsubmission_onlinetext_wordlimit_enabled | 1 |
      | seplsubmission_onlinetext_wordlimit | 10 |
