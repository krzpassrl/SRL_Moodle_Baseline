@mod @mod_sepl
Feature: View the grading status of an seplment
  In order to test the grading status for seplments is displaying correctly
  As a student
  ...
  @javascript
  Scenario: View the grading status for an seplment with marking workflow enabled
    # Add the seplment.
    And I log in as "teacher1"
    And I follow "Course 1"
    And I turn editing mode on
    And I add a "Assignment" to section "1" and I fill the form with:
      | Assignment name | Test seplment name |
      | Description | Test seplment description |
      | Online text | 1 |
    ...
    And I follow "Course 1"
    When I follow "Test seplment name"
    ...
    # The grade should also remain displayed as it's stored in the sepl DB tables, but the final grade should be empty.
    And "Student 1" row "Grade" column of "generaltable" table should contain "50.00"
    And "Student 1" row "Final grade" column of "generaltable" table should contain "-"
    And I log out

  @javascript
  Scenario: View the grading status for an seplment with marking workflow disabled
    # Add the seplment.
    And I log in as "teacher1"
    And I follow "Course 1"
    And I turn editing mode on
