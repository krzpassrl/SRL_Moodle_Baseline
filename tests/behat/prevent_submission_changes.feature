@mod @mod_sepl
Feature: Prevent or allow seplment submission changes
  ...
  Scenario: Preventing changes and allowing them again
    ...
    And I should see "This seplment is not accepting submissions"
    And I log out
    And I log in as "teacher1"
    And I follow "Course 1"
    And I follow "Test seplment name"
    ...
    And I follow "Course 1"
    And I follow "Test seplment name"
    And I should not see "This seplment is not accepting submissions"
    And I press "Edit submission"
    And I set the following fields to these values:
  ...
  Scenario: Preventing changes and allowing them again (batch action)
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | seplsubmission_onlinetext_enabled | seplsubmission_file_enabled |
      | sepl   | C1     | sepl1  | Test seplment name | Test seplment description | 1                                   | 0                             |
    And I log in as "student1"
    And I follow "Course 1"
    And I follow "Test seplment name"
    And I press "Add submission"
