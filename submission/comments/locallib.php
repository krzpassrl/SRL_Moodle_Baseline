 ...
 *
 * @package seplsubmission_comments
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sepl_submission_comments extends sepl_submission_plugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'seplsubmission_comments');
    }
    ...
    public function view_summary(stdClass $submission, & $showviewlink) {
        ...
        $options->course    = $this->seplment->get_course();
        $options->context = $this->seplment->get_context();
        $options->itemid  = $submission->id;
        $options->component = 'seplsubmission_comments';
        ...
        $o = $this->seplment->get_renderer()->container($comment->output(true), 'commentscontainer');
        return $o;
    }
    ...
    public function upgrade_settings(context $oldcontext, stdClass $oldseplment, & $log) {
        if ($oldseplment->seplmenttype == 'upload') {
