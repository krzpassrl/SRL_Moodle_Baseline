 ...
 * needed to restore one sepl_submission subplugin.
 *
 * @package seplsubmission_file
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_seplsubmission_file_subplugin extends restore_subplugin {
     ...
     * @return void
     */
    public function process_seplsubmission_file_submission($data) {
        global $DB;
        ...
        $DB->insert_record('seplsubmission_file', $data);

        $this->add_related_files('seplsubmission_file',
                                 'submission_files',
                                 'submission',
                                 null,
                                 $oldsubmissionid);
