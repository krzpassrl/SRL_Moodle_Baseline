...
/**
 * The seplsubmission_file assessable uploaded event.
 *
...
/**
 * The seplsubmission_file assessable uploaded event class.
 *
 * @package    seplsubmission_file
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'seplsubmission_file');
    }
