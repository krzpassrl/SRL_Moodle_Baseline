 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_sepl_grade_form extends moodleform {
    /** @var seplment $seplment */
    private $seplment;
    ...
    public function definition() {
        ...
        list($seplment, $data, $params) = $this->_customdata;
        // Visible elements.
        $this->seplment = $seplment;
        $seplment->add_grade_form_elements($mform, $data, $params);
