 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class sepl_submission_plugin extends sepl_plugin {
     ...
     * @param stdClass $submission the sepl_submission record being submitted.
     ...
     *
     * @param stdClass|false $submission - sepl_submission data if any
     ...
     *
     * @param stdClass $submission - sepl_submission data
     * @return void
     */
