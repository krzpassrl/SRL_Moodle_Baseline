YUI.add('moodle-mod_sepl-history', function (Y, NAME) {

// Define a function that will run in the context of a
// Node instance:
var CSS = {
        LINK: 'mod-sepl-history-link',
        OPEN: 'mod-sepl-history-link-open',
        CLOSED: 'mod-sepl-history-link-closed',
        PANEL: 'mod-sepl-history-panel'
    },
    COUNT = 0,
    TOGGLE = function() {
        var id = this.get('for'),
