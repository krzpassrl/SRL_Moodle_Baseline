...
class seplsubmission extends base {
    /**
    ...
    public static function get_enabled_plugins() {
        ...
        $plugins = core_plugin_manager::instance()->get_installed_plugins('seplsubmission');
        if (!$plugins) {
            return array();
        }
        $installed = array();
        foreach ($plugins as $plugin => $version) {
            $installed[] = 'seplsubmission_'.$plugin;
        }
    ...
    public static function get_manage_url() {
        return new moodle_url('/mod/sepl/adminmanageplugins.php', array('subtype'=>'seplsubmission'));
    }
