...
/**
 * The mod_sepl submission_created abstract event.
 *
 * @package    mod_sepl
...
/**
 * The mod_sepl submission_created abstract event class.
 *
...
abstract class submission_created extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'mod_sepl');
    }
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['submissionid'] = array('db' => 'sepl_submission', 'restore' => 'submission');
