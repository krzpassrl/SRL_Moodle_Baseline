...
/**
 * The mod_sepl submission unlocked event.
 *
 * @package    mod_sepl
...
/**
 * The mod_sepl submission unlocked event class.
 *
 * @package    mod_sepl
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_unlocked extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionunlocked', 'mod_sepl');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('unlocksubmissionforstudent', 'sepl', array('id' => $user->id, 'fullname' => fullname($user)));
