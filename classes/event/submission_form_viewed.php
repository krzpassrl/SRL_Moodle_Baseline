...
class submission_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionformviewed', 'mod_sepl');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' viewed their submission for the seplment with course module id " .
    ...
    protected function get_legacy_logdata() {
        if ($this->relateduserid == $this->userid) {
            ...
            $title = get_string('editsubmissionother', 'sepl', fullname($user));
        }
        $this->set_legacy_logdata('view submit seplment form', $title);
