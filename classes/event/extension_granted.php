...
/**
 * The mod_sepl extension granted event.
 *
 * @package    mod_sepl
...
/**
 * The mod_sepl extension granted event class.
 *
 * @package    mod_sepl
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class extension_granted extends base {
    ...
    public static function get_name() {
        return get_string('eventextensiongranted', 'mod_sepl');
    }
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call extension_granted::create() directly, use extension_granted::create_from_sepl() instead.');
        }
