...
/**
 * The mod_sepl reveal identities confirmation page viewed event.
 *
 * @package    mod_sepl
...
/**
 * The mod_sepl reveal identities confirmation page viewed event class.
 *
...
class reveal_identities_confirmation_page_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventrevealidentitiesconfirmationpageviewed', 'mod_sepl');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('view', get_string('viewrevealidentitiesconfirm', 'sepl'));
