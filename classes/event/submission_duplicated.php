...
/**
 * The mod_sepl submission duplicated event.
 *
 * @package    mod_sepl
...
/**
 * The mod_sepl submission duplicated event class.
 *
 * @package    mod_sepl
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_duplicated extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionduplicated', 'mod_sepl');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $this->set_legacy_logdata('submissioncopied', $this->sepl->format_submission_for_log($submission));
