...
/**
 * The mod_sepl marker updated event.
 *
 * @package    mod_sepl
...
/**
 * The mod_sepl marker updated event class.
 *
...
class marker_updated extends base {
     ...
     */
    public static function create_from_marker(\sepl $sepl, \stdClass $user, \stdClass $marker) {
        $data = array(
    ...
    public function get_description() {
        return "The user with id '$this->userid' has set the marker for the user with id '$this->relateduserid' to " .
            "'{$this->other['markerid']}' for the seplment with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventmarkerupdated', 'mod_sepl');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('setmarkerallocationforlog', 'sepl', $a);
