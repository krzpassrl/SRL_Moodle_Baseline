...
/**
 * The mod_sepl statement accepted event.
 *
 * @package    mod_sepl
...
/**
 * The mod_sepl statement accepted event class.
 *
 * @package    mod_sepl
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class statement_accepted extends base {
    ...
    public static function get_name() {
        return get_string('eventstatementaccepted', 'mod_sepl');
    }
    ...
    protected function get_legacy_logdata() {
        global $USER;
        $logmessage = get_string('submissionstatementacceptedlog', 'mod_sepl', fullname($USER)); // Nasty hack.
