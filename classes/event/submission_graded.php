...
/**
 * The mod_sepl submission graded event.
 *
 * @package    mod_sepl
...
/**
 * The mod_sepl submission graded event class.
 *
 * @package    mod_sepl
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_graded extends base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has graded the submission '$this->objectid' for the user with " .
            "id '$this->relateduserid' for the seplment with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissiongraded', 'mod_sepl');
    }
    ...
    protected function get_legacy_logdata() {
        $grade = $this->get_record_snapshot('sepl_grades', $this->objectid);
        $this->set_legacy_logdata('grade submission', $this->sepl->format_grade_for_log($grade));
